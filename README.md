...
1. **Прошейте плату**
   ...
   **Самый простой способ — [Web Flasher](https://sogimu.github.io/esp-ot-gateway)** (нужен Chrome и USB-кабель). Откройте страницу, выберите версию прошивки, подключите ESP32 и нажмите «Прошить». Никаких инструментов устанавливать не нужно.
