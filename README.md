...
- 🏠 **Home Assistant из коробки** — MQTT-автообнаружение публикует 27 сущностей: укажите адрес брокера, и котёл сам появится в HA
...
Шлюз публикует **27 автообнаруживаемых сущностей** — без единой строчки YAML:
